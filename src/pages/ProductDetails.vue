      ...
      <div class="tabs_wraper">
        <b-tabs content-class="mt-3">
            ...
            <div class="row">
              <div class="col-12 col-md-3">
                <div class="size_guide_img_wraper">
                  <img src="https://d-themes.com/vue/riode/demo-1/images/product-size.png"> 
                </div>
              </div>
          ...
          <b-tab title="Reviews(2)">
              ...
              <div class="col-12 col-md-6">
                <div class="testimonial_card my-3">
                  <div class="img_wraper">
                    <img src="https://d-themes.com/vue/riode/demo-1/images/blog/comments/1.jpg">
                  </div>
                  ...
                  <div class="testimonial_body">
                    ...
                    <div class="text">
                      Lorem ipsum dolor, sit amet consectetur adipisicing elit. 
                      Iusto nostrum eum alias ipsam ipsum error perferendis culpa. 
                      Consequatur dolorum sapiente quisquam ratione fuga vero numquam 
                      voluptatum error, exercitationem odit expedita.
                    </div>
                  </div>
                </div>
              </div>
            ...
            <h6 class="review_subtitle">Your email address will not be published. Required fields are marked *</h6>
            ...
            <form class="reviews_form">  
              <div class="row">
                <div class="col-12 my-3">
                  <div class="wraper">
                    <textarea class="form-control" placeholder="Comment *" rows="7" v-model="reviewData.comment"></textarea>
                  </div>
                </div>

                <div class="col-12 col-md-6 my-3">
                  <div class="wraper">
                    <input type="text" placeholder="Name *" class="form-control" v-model="reviewData.name">
                  </div>
                </div>

                <div class="col-12 col-md-6 my-3">
                  <div class="wraper">
                    <input type="email" placeholder="Email *" class="form-control" v-model="reviewData.email">
                  </div>
                </div>
...
import {ShoppingCartIcon, HeartIcon, PlusIcon, MinusIcon} from "vue-feather-icons";
