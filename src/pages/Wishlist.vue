    ...
    <div class="container">
      ...
      <div class="wraper" v-else>
        ...
        <v-simple-table>
          ...
          <tbody>
            <tr v-for="item in this.$store.state.wishlist" :key="item.id">
              <td>
                <div class="product">
                  <img :src="item.images[0].img" width="100" height="100" />
              ...
              <td>
                <span
                  class="status text-success text-capitalize"
                  v-if="item.status == 'in stock'"
                >
                  {{ item.status }}
                </span>
                <span
                  class="status text-danger text-capitalize"
