<template>
  <div class="wraper d-flex justify-content-center align-items-center">
    <div class="product_card_wraper">
      <div class="product_image_wraper">
        <div class="badges_wraper">
          <span 
            class="badge"
            v-for=" badge in productData.badges "
            :key=" badge "
          >
            {{ badge }}
          </span>
        ...
        <div class="overlay">
          <div class="actions_btns_wraper">
            ...
            <button class="add_to_wish" v-b-tooltip.hover title="Add To Wishlist">
      ...
      <div class="product_card_body">
        ...
        <h5 class="product_name"> {{ productData.productName.length > 33 ? productData.productName.substring(0,30)+".." : productData.productName }} </h5>
    ...
    <b-modal id="product_modal" class="product_modal" size="xl" hide-header hide-footer>
      <b-button class="mt-3" variant="outline-danger" block @click="$bvModal.hide('product_modal')">Close Me</b-button>
      <h1> Test </h1>
    </b-modal>
  </div>
</template>
...
<script>
import { ArrowRightIcon, HeartIcon, ShoppingCartIcon, XIcon } from "vue-feather-icons";
